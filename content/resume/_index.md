...
[marcos.s.lucas@gmail.com](mailto:marcos.s.lucas@gmail.com) | +598 99 261 620  
[linkedin.com/in/marcos-lucas-93692915](https://linkedin.com/in/marcos-lucas-93692915)

  </div>
  <img class="resume-photo" src="/img/marcos-resume.JPG" alt="Marcos Lucas">
</div>
...
Montevideo, Uruguay  
Total tenure: approximately 19 years
...
- Co-led the architecture and evolution of a multi-tenant GKE platform with principal engineering leadership, enabling scalable container workloads across the organization.
- Contributed to Terraform Enterprise governance, including workspace strategy, execution workflows, and policy controls at enterprise scale.
- Served as Senior Principal Cloud Architect on the SHS, now Aven, separation initiative, designing the GCP organization structure and enabling infrastructure carve-out across approximately 100 service projects, with additional AWS involvement.
- Led cloud network and security architecture decisions, including Shared VPC design and next-generation firewall adoption across the enterprise platform.
- Supported compliance and security control initiatives aligned with ISO 27001 and broader enterprise governance frameworks.
- Acted as a formal mentor within Sabre's mentorship program, supporting the growth of junior engineers and architects.

#### Senior Manager, Cloud Solution Architecture

Jun 2018 – Nov 2021

- Led cloud architecture teams driving on-premises to GCP migration initiatives across multiple business units.
- Advanced multi-cloud adoption across GCP and AWS, including OpenShift-based solutions and early Azure exploration, with a focus on resilient, secure, high-availability architectures.
- Contributed to executive-level business cases that supported Sabre's long-term cloud strategy.

#### Earlier Career at Sabre Corporation

2007 – 2018

Progressed through roles including Technical Project Manager, DevOps and Engineering Manager, System Owner, and Team Lead.

- Led teams of up to 15 engineers across infrastructure and operations initiatives.
- Delivered datacenter migrations, Oracle cluster upgrades, cloud adoption efforts, and global software implementation programs.
- Helped establish DevOps practices, automation standards, and operational metrics for mission-critical production environments.
...
- Taught software engineering fundamentals, including UML modeling and software design theory, while maintaining a full-time industry role.

### DBA / Infrastructure Analyst

Universidad Católica del Uruguay  
2003 – 2007

- Worked on database administration and infrastructure initiatives across DB2, SQL Server, PostgreSQL, and MySQL.
- Contributed to ERP integrations and e-learning platform implementation.

## Education

### Master's in Cybersecurity

OBS Business School, University of Barcelona partner  
2024 – 2025  
GPA: 9.3/10

Business- and governance-oriented cybersecurity program.
